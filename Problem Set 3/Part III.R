...
> cars.use = scale(cars.use, center = medians, scale = mods)
Error in scale.default(cars.use, center = medians, scale = mods) : 
  object 'mods' not found
...
Error in if (is.logical(labels) && !labels) character(n + 1L) else as.character(labels) : 
  missing value where TRUE/FALSE needed
In addition: Warning message:
  In Ops.factor(labels, cars$Car) : - not meaningful for factors
> plot(cars.hclust, labels = cars$Car, main = "Default from hclust")
...
38 Levels: AMC Concord D/L AMC Spirit Audi 5000 BMW 320i Buick Century Special Buick Estate Wagon Buick Skylark ... VW Scirocco
...
[[2]]
[1] Chevette         Toyota Corona    Datsun 510       Dodge Omni       Audi 5000        Saab 99 GLE      Ford Mustang 4   Mazda GLC       
[9] Dodge Colt       AMC Spirit       VW Scirocco      Honda Accord LX  Buick Skylark    Pontiac Phoenix  Plymouth Horizon Datsun 210      
[17] Fiat Strada      VW Dasher        BMW 320i         VW Rabbit       
38 Levels: AMC Concord D/L AMC Spirit Audi 5000 BMW 320i Buick Century Special Buick Estate Wagon Buick Skylark ... VW Scirocco

[[3]]
[1] Volvo 240 GL          Peugeot 694 SL        Buick Century Special Mercury Zephyr        Dodge Aspen           AMC Concord D/L      
[7] Ford Mustang Ghia     Chevy Citation        Olds Omega            Datsun 810           
38 Levels: AMC Concord D/L AMC Spirit Audi 5000 BMW 320i Buick Century Special Buick Estate Wagon Buick Skylark ... VW Scirocco
...
[[2]]
[1] Chevette         Toyota Corona    Datsun 510       Dodge Omni       Ford Mustang 4   Mazda GLC        Dodge Colt       AMC Spirit      
[9] VW Scirocco      Honda Accord LX  Buick Skylark    Pontiac Phoenix  Plymouth Horizon Datsun 210       Fiat Strada      VW Dasher       
[17] VW Rabbit       
38 Levels: AMC Concord D/L AMC Spirit Audi 5000 BMW 320i Buick Century Special Buick Estate Wagon Buick Skylark ... VW Scirocco
...
Warning messages:
  1: package 'flexclust' was built under R version 3.0.3 
